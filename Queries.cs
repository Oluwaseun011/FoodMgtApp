...
namespace FoodDeliveryApp
{
    ...
    {
        public const string customertable = "create table if not exists Customer(Id int auto_increment, Name varchar(50),Email varchar(50) unique, Address varchar(50), primary key(id) );";
